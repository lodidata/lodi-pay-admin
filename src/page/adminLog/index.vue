<template>
  <div id="AdminLog">
    ...
    <date-more :dates.sync="created_at" :title="i18n_lang.adminLog0"></date-more>
      ...
      <div class="query_con">
        ...
        <div class="item">
          ...
          <Select v-model="query.module" style="width:100px">
            ...
            <Option v-for="(it,i) in moduleList" :key="i" :value="it">{{ it }}</Option>
          </Select>
        </div>
        <div class="item">
...
export default {
  data() {
    ...
    return {
      ...
      //dataValue: [initDate.from,initDate.to ], // 默认日期

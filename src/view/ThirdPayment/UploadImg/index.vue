<template>
  <div id="UploadImg">
    ...
    <Button v-if="value" type="error" @click="delImg()">{{i18n_lang.activeListNew3}}</Button>
    <p v-if="type == 'logo'">{{i18n_lang.activeListNew2}}</p>
    <p v-else-if="type == 'guide_url'">移动端图片建议尺寸：600宽，高度不限</p>
    <p v-else>{{i18n_lang.activeListNew0}}</p>
  </div>
</template>
<script>
export default {

...
export default function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      align: 'center',
      render(h, { row }) {
        return <span>{row.min_money === 0 ? i18n.thirdPayment40 : row.min_money}</span>
      }
    },
    {
      ...
      align: 'center',
      render(h, { row }) {
        return <span>{row.max_money === 0 ? i18n.thirdPayment40 : row.max_money}</span>
      }
    },
    {
      ...
      align: 'center',
      render(h, { row }) {
        return <span>{row.money_stop === 0 ? i18n.thirdPayment40 : row.money_stop}</span>
      }
    },
    {
      ...
      align: 'center',
      render(h, { row }) {
        return <span>{row.money_day_stop === 0 ? i18n.thirdPayment40 : row.money_day_stop}</span>
      }
    },
    {

  ...
  <div>
    ...
    <Card dis-hover class="query_box">
      <div class="item">
        ...
        <Button type="primary" icon="md-download" @click="exportData()">{{i18n_lang.RetentionRate3}}</Button><!-- v-if="allRoutes.indexOf('271') > -1" -->
      </div>
    </Card>
    ...
    methods: {
      ...
      async getList(index = 1) {//获取数据
        ...
        const res = await this.$axios.request({
          url: '/channel/retention/recharge',
          method: 'GET',
          params: {
            ...req
      ...
      async exportData(){
        ...
        const res = await this.$axios.request({
          url: '/channel/retention/recharge/export',
          method: 'GET',
          responseType: 'blob',
          params: {
            ...req
